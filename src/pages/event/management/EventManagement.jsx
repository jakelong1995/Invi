      ...
      <div className="navManagement flex flex-col items-center justify-around w-2/3 m-auto ">
        ...
        <div className="navPanel">
          ...
          <div className="tab-content">
            ...
            {activeTab === "tab2" && (
              <div>Guest is under development. Coming soon</div>
            )}
            {activeTab === "tab3" && (
              <div>Registration is under development. Coming soon</div>
            )}
            {activeTab === "tab4" && (
              <div>Emails is under development. Coming soon</div>
            )}
            {activeTab === "tab5" && (
              <div>Insights is under development. Coming soon</div>
            )}
            {activeTab === "tab6" && (
              <div>More is under development. Coming soon</div>
            )}
